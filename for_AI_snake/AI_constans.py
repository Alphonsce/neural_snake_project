...
MAX_MEMORY = 100_000
BATCH_SIZE = 1000
LR = 0.005      # learning rate, отвечает за размер шага в градиентном спуске
...
WAITING_CONSTANT = 100      # отвечает за то как долго мы готовы ждать конца, когда агент циклит одно движение
#---------------
